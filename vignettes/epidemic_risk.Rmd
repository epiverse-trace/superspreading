...
ggplot2::ggplot(data = homogeneity) +
  ...
  ggplot2::geom_vline(
    mapping = ggplot2::aes(xintercept = 0.2),
    linetype = "dashed"
  ) +
  ggplot2::annotate(geom = "text", x = 0.15, y = 0.75, label = "SARS") +
  ggplot2::geom_vline(
    mapping = ggplot2::aes(xintercept = 0.4),
    linetype = "dashed"
  ) +
...
# plot probability of epidemic across introductions for multiple k
ggplot2::ggplot(data = contain_params) +
  ggplot2::geom_point(
    mapping = ggplot2::aes(
      x = c,
      y = prob_contain,
  ...
  ggplot2::scale_x_continuous(name = "Control measures (*c*)", n.breaks = 6) +
  ggplot2::labs(colour = "Dispersion (*k*)") +
  ggplot2::scale_color_viridis_d() +
  ggplot2::theme_bw() +
  ggplot2::theme(
