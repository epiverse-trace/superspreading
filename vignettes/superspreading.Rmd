...
primary case) without specifying it as the basic reproduction number ($R_0$)
or the effective reproduction number ($R_t$). This is because either 
can be applied to the functions provided by {superspreading}.
:::
