...
This vignette explores the `proportion_transmission()` function in {superspreading}. The function calculates what proportion of cases causes a certain proportion of transmission for an infectious disease outbreak. 
...
get_infectious_curve <- function(R, k) {
  ...
  u_seq <- lseq(from = 1e-5, to = upper_u, length.out = 500)
