...
Additionally, {ggplot2} is used for plotting, {quickfit} is used to assist with
multiple model fitting and comparison, and {kableExtra} is used for formatting
tables.
...
kable_styling(kable_input = tbl, position = "center")
```
...
# create data frame with proportion of cases, density and number of secondary cases
...
# make plot
ggplot2::ggplot(data = nbinom_data) +
  ggplot2::geom_col(mapping = ggplot2::aes(x = x, y = prop_num_cases), fill = "cyan3", colour = "black") +
  ggplot2::geom_point(mapping = ggplot2::aes(x = x, y = density), colour = "coral", size = 2) +
  ggplot2::geom_line(mapping = ggplot2::aes(x = x, y = density), colour = "coral") +
  ggplot2::scale_x_continuous(name = "Number of secondary cases") +
...
# make plot
ggplot2::ggplot(data = dist_compare_data) +
  ggplot2::geom_col(mapping = ggplot2::aes(x = x, y = prop_num_cases), fill = "cyan3", colour = "black") +
  ggplot2::geom_point(mapping = ggplot2::aes(x = x, y = dens, colour = dist), size = 2) +
  ggplot2::geom_line(mapping = ggplot2::aes(x = x, y = dens, colour = dist)) +
  ggplot2::scale_x_continuous(name = "Number of secondary cases") +
  ggplot2::scale_y_continuous(name = "Frequency") +
  ggplot2::scale_colour_manual(name = "Distribution", values = c("coral", "deeppink")) +
  ggplot2::theme_bw() +
