test_that("probability_epidemic works for R < 1", {
  expect_identical(probability_epidemic(R = 0.5, k = 0.5, a = 1), 0)
  expect_identical(probability_epidemic(R = 0.5, k = 0.1, a = 1), 0)
  expect_identical(probability_epidemic(R = 0.5, k = 0.5, a = 50), 0)
})
...
test_that("probability_extinct works for R < 1", {
  expect_identical(probability_extinct(R = 0.5, k = 0.5, a = 1), 1)
  expect_identical(probability_extinct(R = 0.5, k = 0.1, a = 1), 1)
  expect_identical(probability_extinct(R = 0.5, k = 0.5, a = 50), 1)
})
