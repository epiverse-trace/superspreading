...
*superspreading* provides functions for estimating individual-level variation in transmission
...
You can install the development version of _superspreading_ from
